...
export default function Nav({ show }) {
  ...
  const activeLink =
    inactiveLink + " bg-highlight px-2 py-1 rounded text-bgGray rounded-sm";
  const inactiveIcon = "w-10 h-6";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 p-6 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"
      }
    >
